<!-- registry-sync: version=11.8.0; skills=1481; stars=38909; updated_at=2026-05-27T19:36:33+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,481+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,481+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,481+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,481+ Skills](#browse-1481-skills)
...
If you want a faster answer than "browse all 1,481+ skills", start with a tool-specific guide:
