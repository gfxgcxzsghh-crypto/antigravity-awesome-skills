...
✅ **Downloaded 1,481+ skill files** to your computer (default: `~/.agents/skills/`; or a custom path like `~/.agent/skills/` if you used `--path`)
...
- You installed a toolbox with 1,481+ tools (✅ done)
...
Don't try to use all 1,481+ skills at once. Here's a sensible approach:
...
No. Even though you have 1,481+ skills installed locally, you should **not** concatenate every `SKILL.md` into a single system prompt or context block.
